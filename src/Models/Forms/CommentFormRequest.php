...
class CommentFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'user_id'        => ['required_without:name','string','exists:'.config('wk-core.table.user').',id'],
        ...
        if ($request->isMethod('put') && isset($request->id)) {
            $rules = array_merge($rules, ['id' => ['required','string','exists:'.config('wk-core.table.morph-comment.comments').',id']]);
        }
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if (isset($data['morph_type']) && isset($data['morph_id'])) {
                if ( config('wk-morph-comment.onoff.site') && !empty(config('wk-core.class.site.site')) && $data['morph_type'] == config('wk-core.class.site.site') ) {
                ...
                } elseif ( config('wk-morph-comment.onoff.group') && !empty(config('wk-core.class.group.group')) && $data['morph_type'] == config('wk-core.class.group.group') ) {
                ...
                } elseif ( config('wk-morph-comment.onoff.mall-order') && !empty(config('wk-core.class.mall-order.order')) && $data['morph_type'] == config('wk-core.class.mall-order.order') ) {
                ...
                } elseif ( config('wk-morph-comment.onoff.mall-shelf') && !empty(config('wk-core.class.mall-shelf.stock')) && $data['morph_type'] == config('wk-core.class.mall-shelf.stock') ) {
                ...
                } elseif ( config('wk-morph-comment.onoff.morph-image') && !empty(config('wk-core.class.morph-image.image')) && $data['morph_type'] == config('wk-core.class.morph-image.image') ) {
            ...
            if (isset($data['score'])) {
                switch (config('wk-morph-comment.score.type')) {
                    case "both":
                        if (!is_integer($data['score']) && !is_float($data['score']))
