...
namespace WalkerChiu\MorphComment\Models\Observers;

class CommentLangObserver
{
    /**
    ...
    {
        $query =
            config('wk-core.class.morph-comment.commentLang')::withTrashed()
        ...
        if (config('wk-morph-comment.soft_delete') && (config('wk-core.lang_log') || config('wk-morph-comment.lang_log')))
